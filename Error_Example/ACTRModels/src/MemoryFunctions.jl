...
function spreadingActivation!(memory, imaginal, chunk)
    ...
    chunk.act += sa#max(0.0,sa)#causes errors in gradient
    return nothing
end
...
"""
function addChunk!(memory::T, curTime=0.0; act=0.0, slots...) where {T<:Declarative}
...
"""
function retrievalRequest(Memory::T; request...) where {T<:Declarative}
